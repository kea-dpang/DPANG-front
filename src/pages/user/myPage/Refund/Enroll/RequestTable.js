...
function RequestTable() {
  ...
  const [category, setCategory] = useState("SIMPLE_CHANGE");
  ...
  return (
    <Wrapper>
      <DetailHeader className="cm-SRegular16">환불 신청하기</DetailHeader>
      <Container>
        <Border />
        <TableBox className="cm-SRegular16">
          <Row height="6rem">
            <ColHeader height="6rem" className="cm-SBold16">
              환불 사유
            </ColHeader>
          ...
          <Row height="15rem" className="cm-SRegular16">
            <ColHeader height="15rem" className="cm-SBold16">
              비고
            </ColHeader>
          ...
          <Row height="10rem" className="cm-SRegular16">
            <ColHeader height="10rem" className="cm-SBold16">
              회수 메시지
            </ColHeader>
