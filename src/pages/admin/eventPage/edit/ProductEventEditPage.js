...
const Index = ({ eventId }) => {
    ...
    const handleItemDelete = (productToDelete) => () => {
        setEventData(prevData => ({
            ...prevData,
            eventItems: prevData.eventItems.filter((product) => product !== productToDelete),
        }));
    };
    // 이벤트 할인율 변경 감지
    ...
    return (
        ...
        {eventData && (
                           ...
                           >
                               <LocalizationProvider dateAdapter={AdapterDayjs}>
                                   <DemoContainer components={['DatePicker']}>
                                       <DatePicker label="이벤트 시작일" value={dayjs(eventData.startDate)} onChange={handleStartChange}/>
                                   </DemoContainer>
                   ...
                   <Row>
                       ...
                       <Content>
                           ...
                           >
                               <LocalizationProvider dateAdapter={AdapterDayjs}>
                                   <DemoContainer components={['DatePicker']}>
                                       <DatePicker label="이벤트 종료일" value={dayjs(eventData.endDate)} onChange={handleEndChange}/>
                                   </DemoContainer>
                               </LocalizationProvider>
                           </Box>
                       </Content>
               ...
               {/* 등록버튼 */}
               <Submit>
                   <button type='submit' className='Btn_S_Navy' onClick={handleSubmit}>수정 완료</button>
               </Submit>
