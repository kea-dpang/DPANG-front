...
const Index = () => {
  ...
  const columns = [
    ...
    {name: "requestdate", label: "요청일자"}, 
    {name: "kind", label: "처리 상태", },
    { name: "name", label: "이름"},
    { name: "payname", label: "입금자명"},
    { name: "money", label: "충전 희망 금액"},
    { name: "kind", label: "충전 상태 관리", options: {
      customBodyRender: (value, tableMeta) => {

        return value === '대기' ? <ButtonBox style={{display: "flex"}}>
