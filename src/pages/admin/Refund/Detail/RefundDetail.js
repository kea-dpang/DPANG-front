...
function RefundDetail(props) {
  ...
  return (
    <Container>
      ...
      <DetailTableTitle text="환불 상세 정보" width="73.9375rem" handleclick={handleRefundClick} />

      {refundClick && <DetailRefund data={data} />}

      <Blank height="3rem"/>
      <DetailTableTitle text="회수처 정보" width="73.9375rem" handleclick={handleShipClick} />
      {shipClick && <DetailShip data={data} />}

      <Blank height="3rem"/>
      <DetailTableTitle text="결제정보" width="73.9375rem" handleclick={handlePayClick} />
