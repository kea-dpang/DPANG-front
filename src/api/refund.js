...
const POST_refund_order = async (inputValue) => {
...
const GET_refund_detail = async (refundId) => {
...
const GET_refund_list = async (inputValue) => {
...
const PUT_update_status = async (orderId) => {
  const res = await axios({
    method: "put",
    url: `${url}/${orderId}`,
  });
